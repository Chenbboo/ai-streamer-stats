...
create table if not exists jewelry_document_item (
  ...
  supplier_name_snapshot varchar(128) default null comment '样品入库明细供应商名称快照',
  sample_goods_no varchar(64) default null comment '样品入库明细货号，与商品SKU独立',
...
join sys_menu m on m.menu_id in (3000,3002,3003,3004,3005,3006,3009,3010,3011,3103,3104,3107,3108,3109,3110,3118,3119,3121,3122)
