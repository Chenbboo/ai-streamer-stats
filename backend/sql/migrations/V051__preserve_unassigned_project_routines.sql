...
-- V049 retired orphaned routines because the assignee columns were not nullable. Restore only rows
...
set routine.status='ACTIVE',routine.assignee_user_id=null,routine.assignee_name=null,
    routine.update_by='migration-v051',routine.update_time=sysdate(),routine.version=routine.version+1
where routine.status='VOID' and routine.update_by='migration-v049';
