...
/** 阶段验收提交与老板评审记录；每条记录对应一个项目里程碑。 */
public class BusinessProjectStageAcceptance extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Long stageAcceptanceId;
    ...
    public Long getStageAcceptanceId() { return stageAcceptanceId; }
    public void setStageAcceptanceId(Long stageAcceptanceId) { this.stageAcceptanceId = stageAcceptanceId; }
