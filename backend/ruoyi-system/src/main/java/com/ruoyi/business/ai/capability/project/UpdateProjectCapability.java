...
public class UpdateProjectCapability implements AiConfirmableCapability
{
    ...
    public Map<String,Object> inputSchema(){Map<String,Object>s=AiSchemas.object();
        ...
        AiSchemas.property(s,"accountingMode","string","PROFIT/COST/VALUE/HYBRID");AiSchemas.property(s,"managementMode","string","LIGHT/STANDARD/KEY_CONTROL");
        AiSchemas.property(s,"closeMethod","string","DIRECT/RESULT_ACCEPTANCE/STAGED_ACCEPTANCE");AiSchemas.property(s,"managementReason","string","重点监管原因");AiSchemas.property(s,"acceptanceCriteria","string","验收标准");AiSchemas.property(s,"governanceChangeReason","string","执行中调整治理方式的原因");
