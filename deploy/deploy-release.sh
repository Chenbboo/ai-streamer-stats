...
if [[ ! "$first_migration" =~ ^[1-9][0-9]*$ ]] || (( first_migration < 10 || first_migration > 131 )); then
  echo "first migration version must be between 10 and 131 (131 skips migrations)" >&2
  exit 1
fi
