...
发布包包含 V010–V095。默认从 V010 执行；已核实完成 V093 的环境，本次依次执行 V094、V095。V094 允许立项草稿暂缺归属老板、归属公司和计划开始日期；V095 在上海公司下补齐七个部门，保留已有同名部门和人员归属。发布门禁会校验上述三个草稿字段允许为空，正式启动仍由业务校验阻止资料不完整的草稿：
