<template>
    <div>
        <el-tabs type="border-card">
            <el-tab-pane :label="$tr(&quot;秒&quot;)" v-if="shouldHide('second')">
                <CrontabSecond
            ...
            <el-tab-pane :label="$tr(&quot;分钟&quot;)" v-if="shouldHide('min')">
                <CrontabMin
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$tr(&quot;小时&quot;)" v-if="shouldHide('hour')">
                <CrontabHour
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$tr(&quot;日&quot;)" v-if="shouldHide('day')">
                <CrontabDay
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$tr(&quot;月&quot;)" v-if="shouldHide('month')">
                <CrontabMonth
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$tr(&quot;周&quot;)" v-if="shouldHide('week')">
                <CrontabWeek
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$tr(&quot;年&quot;)" v-if="shouldHide('year')">
                <CrontabYear
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
        ...
        <div class="popup-main">
            ...
            <div class="pop_btn">
                <el-button type="primary" @click="submitFill">{{ $tr("确定") }}</el-button>
                <el-button type="warning" @click="clearCron">{{ $tr("重置") }}</el-button>
                <el-button @click="hidePopup">{{ $tr("取消") }}</el-button>
            </div>
        </div>
    </div>
</template>
...
const tabTitles = ref([translateText("秒"), translateText("分钟"), translateText("小时"), translateText("日"), translateText("月"), translateText("周"), translateText("年")])
