...
import { ArrowRight, Checked, Clock, DocumentChecked, Warning } from '@element-plus/icons-vue'
const data = ref({})
...
const notices = [
  { key: 'pendingFirstCount', label: '张单据待一审', name: '待一审单据', icon: DocumentChecked, path: '/jewelry/approval', query: { status: 'PENDING_FIRST' } },
  { key: 'pendingSecondCount', label: '张单据待复核', name: '待复核单据', icon: Checked, path: '/jewelry/approval', query: { status: 'PENDING_SECOND' } },
