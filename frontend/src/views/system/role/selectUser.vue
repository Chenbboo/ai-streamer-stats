<template>
   <!-- 授权用户 -->
   <el-dialog :title="$tr(&quot;选择用户&quot;)" v-model="visible" width="800px" top="5vh" append-to-body>
      ...
      <template #footer>
         <div class="dialog-footer">
            <el-button type="primary" @click="handleSelectUser">{{ $tr("确 定") }}</el-button>
...
function handleSelectUser() {
  ...
  if (uIds == "") {
    proxy.$modal.msgError(translateText("请选择要分配的用户"))
    return
  }
