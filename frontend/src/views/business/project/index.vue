...
function openRoutine(row={}){Object.assign(routineForm,{routineId:null,projectId:detail.value.projectId,routineName:'',frequency:'DAILY',targetMode:'FIXED',targetValue:null,unit:'条',assigneeUserId:detail.value.mainOwnerUserId,startDate:detail.value.planStartDate||todayText(),endDate:detail.value.planEndDate||null,evidenceRequired:'0',remark:'',version:null,...row,targetMode:row.targetMode||'FIXED',frequency:'DAILY'});routineLongTerm.value=!!routineForm.startDate&&!routineForm.endDate;routineDialog.value=true}
