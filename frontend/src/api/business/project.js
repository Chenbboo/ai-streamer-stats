...
export const reviewBusinessMemberLeave = (requestId, data) => request({ url: `/business/boss/leave-request/${requestId}/review`, method: 'put', data })
export const cancelBusinessMemberLeaveRequest = (requestId, data) => request({ url: `/business/leave-request/${requestId}/cancel`, method: 'post', data })
