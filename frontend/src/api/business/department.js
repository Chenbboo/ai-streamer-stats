...
export const assignBusinessDepartmentStaff = (deptId, userIds) => request({ url: `/business/department/${deptId}/staff`, method: 'post', data: userIds })
export const removeBusinessDepartmentStaff = (deptId, userId) => request({ url: `/business/department/${deptId}/staff/${userId}`, method: 'delete' })
